...
mmengine.registry.MODELS.register_module(module=SegDataPreProcessor)
mmengine.registry.TRANSFORMS.register_module(module=LoadImageFromNDArray)
mmengine.registry.TRANSFORMS.register_module(module=PackSegInputs)
